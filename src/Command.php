...
abstract class Command
{
    ...
    /**
     * Ask for input from user in terminal.
     *
     * @param string $prompt The question/prompt message
     * @param bool $required If true, keep asking until user input is not empty
    ...
    protected function askHidden(string $prompt): string
    {
        if (strncasecmp(PHP_OS, 'WIN', 3) == 0) {
            // Windows (tidak native mendukung shell_exec)
