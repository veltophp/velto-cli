...
class Help
{
    public function handle(array $args = []){
        ...
        echo "  \033[36mmake:axion:seeder <Name> \033[0m                            Create an Axion seeder file with the given name\n";
        echo "  \n";
        ...
        echo "  \033[36mclear:log:seeder\033[0m                                     Clear log seeder files\n";
        echo "  \n";
        ...
        echo "  \033[36mmigrate:axion:seeder\033[0m                                 Run the axion seeder migration\n";
        echo "  \n";
